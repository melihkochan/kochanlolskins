      ...
      >
        <div className="flex items-center gap-2">
          <div className="flex items-baseline gap-2">
            <div className="text-sm font-bold text-text-primary tracking-wide bg-gradient-to-r from-primary-500 to-primary-600 bg-clip-text text-transparent">
              KOCHAN
            </div>
      ...
      >
        ...
        <div className="flex items-center gap-1 ml-2">
          <Button
            ...
            onClick={() => handleOpenExternal('https://discord.gg/W33UDBskAH')}
          ...
          <Button
            ...
            size="icon"
            className="w-8 h-8 rounded"
            onClick={() => handleOpenExternal('https://github.com/melihkochan')}
